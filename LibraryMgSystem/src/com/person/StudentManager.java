...
public class StudentManager {
	...
	public boolean deleteStudent(int delete_rollNumber) {
		...
		while (student_iterator.hasNext()) {
			...
			if(student.getRollNumber() == delete_rollNumber) {
	...
	public boolean updateStudent(int update_rollNumber,String name, String emailId, String phoneNumber, String address, String dob, int std,
			String division) {
		ListIterator<Student> student_iterator = (ListIterator<Student>) student_list.listIterator();
		while (student_iterator.hasNext()) {
			Student student = student_iterator.next();
			if(student.getRollNumber() == update_rollNumber) {
